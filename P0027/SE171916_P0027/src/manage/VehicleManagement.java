...
public class VehicleManagement implements IVehicleManagement {
    ...
    public void addNewVehicle() {
        ...
        while (productYear.after(currentDate)) {
    ...
    public void searchByType() {
        System.out.println("SEARCH VEHICLE BY TYPE");
        ...
        ArrayList<Vehicle> searchByType = new ArrayList<>();
        type = Utils.getString("Enter Vehicles Type: ", "Vhicles Type cannot be empty");
        ...
        if (searchByType.isEmpty()) {
            ...
            for (Vehicle v : searchByType) {
                if (getYearFromDate(v.getProductYear()) <= 2020) {
                    System.out.println(v);
                }
            }
        }
